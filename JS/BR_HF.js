...
// Переменные 
var _fh_namber="BathRoom";
var _fh_condition="wb-w1/28-00000e48888e";   // Адрес датчика температуры 
var _fh_frequency=10000;   // частота в мс.
var _fh_rele="wb-mr6c_48/K4";
var _fh_delta=1;         // Delta
var timer_id_fh1 
//
var _fh_set = "floor_heating1/temp";      // Название и порядковый номер модуля !!! не должны повторяться в рамках одного прибора !!!   Уставка
var _fh_ON_OFF="floor_heating1/switch";   // Название и порядковый номер модуля !!! не должны повторяться в рамках одного прибора !!!   Включение / Выключение 
var _fh_HF_UP="floor_heating1/temp_up";
var _fh_HF_DN="floor_heating1/temp_dn";


defineVirtualDevice("floor_heating1",  {  // Название и порядковый номер модуля !!! не должны повторяться в рамках одного прибора !!!
